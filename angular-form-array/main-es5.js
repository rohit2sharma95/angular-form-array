...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(_FormBuilder, _MainService) {
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this._MainService.getData().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeWhile"])(function () {
            return _this.alive;
          })).subscribe({
            next: function next(data) {
              if (data && data.modules) {
                data.modules.forEach(function (module) {
                  _this.modules.push(_this.generateModule(module));
                });
              }
            }
          });
        ...
        key: "generateModule",
        value: function generateModule(module) {
          var _this2 = this;

          var generateSubModules = function generateSubModules(subModules) {
            var formArray = _this2._FormBuilder.array([]);

            subModules.forEach(function (val) {
              formArray.push(_this2._FormBuilder.group({
          ...
          var control = this._FormBuilder.group({
        ...
        key: "toggleInnerStatus",
        value: function toggleInnerStatus(control) {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"]],
      providers: [],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/runner/work/angular-form-array/angular-form-array/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
